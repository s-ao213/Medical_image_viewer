...
**真っ黒の場合**
1. Window Levelスライダーを左に動かす（値を小さく）
2. Window Widthを大きく（1000程度）にしてから再調整

**真っ白の場合**
1. Window Levelスライダーを右に動かす（値を大きく）

### ファイルが開けない

考えられる原因
- DICOMファイルでない（拡張子が.dcmでも中身が異なる場合がある）
